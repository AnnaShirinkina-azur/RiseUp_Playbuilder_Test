...
#gr.landscape{--gw:844px;--gh:844px}
...
@media(max-aspect-ratio:844/844){#gr.landscape{width:100vw;height:calc(100vw*844/844)}}
@media(min-aspect-ratio:844/844){#gr.landscape{height:100vh;width:calc(100vh*844/844)}}
</style>
</head>
<body>
