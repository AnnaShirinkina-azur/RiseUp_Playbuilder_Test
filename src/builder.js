...
function readConfig(){
  ...
  return{
    ...
    playerColor:g('cfg-playerColor'),playerSize:g('cfg-playerSize'),playerDeathAnimSpeed:g('cfg-playerDeathAnimSpeed'),playerSpriteColor:g('cfg-playerSpriteColor'),playerRopeColor:g('cfg-playerRopeColor'),playerStart,
