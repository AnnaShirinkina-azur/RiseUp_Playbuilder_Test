...
function readConfig(){
  ...
  return{
    ...
    shieldCount:(function(){var v=g('cfg-shieldCount');return isNaN(v)?1:Math.max(1,Math.round(v));})(),
    shieldMulti:(function(){var e=document.getElementById('cfg-shieldMulti');return !!(e&&e.checked);})(),
    shieldImageCount:Object.keys(SPRS).filter(function(k){return /^shield_\d+$/.test(k);}).length,
